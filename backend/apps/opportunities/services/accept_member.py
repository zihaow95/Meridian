"""Accept a pending proposal team invitation."""
...
class AcceptOpportunityMember:
    ...
    def execute(self) -> OpportunityMember:
        ...
        with transaction.atomic():
            ...
            member.save(update_fields=["invitation_status", "updated_at"])

            append_event(
                AuditRecord(
                    actor=actor,
                    action_code="opportunity.member.accept",
            ...
            register_outbox_event(
                OutboxMessage(
                    event_type="opportunity.member_accepted",
